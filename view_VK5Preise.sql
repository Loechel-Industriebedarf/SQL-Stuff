WITH cte AS 
	(SELECT TOP (2147483647) dbo.PREISGRUPPEN.ARTIKELNR, dbo.ARTIKEL.KEK, dbo.ARTIKEL.LEK, dbo.PREISGRUPPEN.PREIS, dbo.PREISGRUPPEN.ROWID
    FROM dbo.PREISGRUPPEN 
	INNER JOIN dbo.ARTIKEL ON dbo.PREISGRUPPEN.ARTIKELNR = dbo.ARTIKEL.ARTIKELNR
    WHERE (dbo.PREISGRUPPEN.GRUPPE = 5 AND (dbo.ARTIKEL.GELOESCHT = 1))
